...
<center>
![](../Figures/New vehicle by race.png){width = 300px}

Likelihood of purchasing a used vehicle by race
<center>
![](../Figures/Used vehicle by race.png){width = 300px}
...
- Anticipated price of future vehicle by age with gender as factor
<center>
...
![](../Figures/Income distribution from recontact.png){width = 300px}

Dealerships visited by those in the recontact survey
![](../Figures/Dealerships visited.png){width = 300px}


The following two are different plots of the most important factors in their purchase decision

![](../Figures/Most important factors 1.png){width = 300px}
![](../Figures/Most important factors 2.png){width = 300px}

Reasons for not purchasing
![](../Figures/Reason for not purchasing.png){width = 300px}


What features made respondents more satisfied with their purchase
![](../Figures/Purchase satisfaction.png){width = 300px}
